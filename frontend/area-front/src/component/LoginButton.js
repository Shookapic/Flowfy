    ...
    const handleLogin = async () => {
        if (window.Capacitor?.isNative) {
            try {
                ...
                await Browser.open({
                    url: 'https://flowfy.duckdns.org:3000/api/auth/google?prompt=select_account',
                    windowName: '_self',
            ...
            window.open(
                'https://flowfy.duckdns.org:3000/api/auth/google?prompt=select_account',
                '_blank',
            ...
            const messageListener = (event) => {
                if (event.origin !== 'https://flowfy.duckdns.org:3000') {
